package com.example.ey.ui.main.fragments.service.adapter
...
class ServiceAdapter(var context: Activity, userArrayList: ArrayList<ServiceList>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    var userArrayList: ArrayList<ServiceList>
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val user: ServiceList = userArrayList[position]
